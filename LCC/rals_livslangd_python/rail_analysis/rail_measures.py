...
def get_h_index(df, profile, gauge=None):
    """
...
def get_wear_data(df, profile, gauge=None):
    """
...
def get_rcf_residual(df, profile, gauge=None):
    """
...
def get_rcf_depth(df, profile, gauge=None):
    """
